...
public class FrostTower : Tower
{
    ...
    {
        get { return base._data.debuff; }
    }

    public int freezeMax
    {
        get { return base._data.debuffMax; }
    }
    ...
    {
        base.OnProduce();
        Events.onTileChange.AddListener(OnLevelChange);
        MarkTiles();
    }
    ...
    {
        UnmarkTiles();
        Events.onTileChange.RemoveListener(OnLevelChange);
    }
