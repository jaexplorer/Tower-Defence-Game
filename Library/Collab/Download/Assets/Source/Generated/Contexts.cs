...
public partial class Contexts : Entitas.IContexts {
    ...
    public TowerContext tower { get; set; }

    public Entitas.IContext[] allContexts { get { return new Entitas.IContext [] { enemy, game, input, level, projectile, tower }; } }
