...
public class Fog : ManagedObject
{
    [SerializeField] private Transform _transform;
    [SerializeField] private MeshFilter _meshFilter;
    [SerializeField] private MeshRenderer _meshRenderer;
    private FogTower _tower;
    private Tile _tile;
    private bool _isShown;
    private int _distanceFromFog = 10;
    private List<FogTower> _towers = new List<FogTower>(2);
    ...
    public int distanceFromTower
    {
        get { return _distanceFromFog; }
        set { _distanceFromFog = value; }
    }
    ...
    //PRIVATE//////////////////////////////////////////////////
    public void AddTower(FogTower tower, int distance, bool showImmediately = false)
    {
        _towers.Add(tower);
        _tower = _towers[0];
    ...
    public void RemoveTower(FogTower tower)
    {
